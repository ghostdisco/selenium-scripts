...
# Exception catches any other errors that may occur
    ...
    print(f'an error occurred while getting the query box: {e}')
...
try:
    ...
    print(f'an error occurred while getting the submit button: {e}')
...
try:
    ...
    print(f'an error occurred while retrieving search results: {e}')
